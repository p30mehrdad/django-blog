...
class RegistrationSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        return User.objects.create_user(**validated_data) # because in models we create new function for create user 
...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Profile
        fields = ['email','id','first_name','last_name','image','description']
